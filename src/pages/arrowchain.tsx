...
export default function ArrowChain() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-amber-50 to-orange-50 dark:from-slate-900 dark:via-amber-900 dark:to-orange-900">
      <Navigation currentPage="arrowchain" />
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-2xl text-amber-600 dark:text-amber-400 font-semibold mb-4">
              Multi-Industry Blockchain Ecosystem Platform
            </p>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 dark:text-gray-300 mb-8">
                ArrowChain serves as the backbone infrastructure connecting all Bloqz Technologies blockchain systems, 
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-slate-800">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ArrowChain unifies all 13 specialized blockchain platforms into one cohesive ecosystem
            </p>
          </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/30 dark:to-purple-900/30">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
              ArrowChain is coming soon with exclusive multi-industry blockchain unification capabilities.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-2xl p-8 shadow-xl max-w-2xl mx-auto">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Enterprise-grade 10.5" Android tablets with ArrowChain pre-installed for ecosystem orchestration.
              </p>
            </div>
      ...
      <footer className="border-t bg-white dark:bg-slate-900 py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          <p className="text-gray-600 dark:text-gray-300">
            ...
            ArrowChain - Unifying Blockchain Ecosystems Through Cross-Industry Innovation. Coming Q4 2027.
          </p>
        </div>
      </footer>
    </div>
