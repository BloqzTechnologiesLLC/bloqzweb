...
export default function InvestorRelationsPage() {
  ...
  const recentNews = [
    {
      ...
      title: "Bloqz Technologies Launches ArrowChain Multi-Industry Platform",
  ...
  const upcomingEvents = [
    ...
    },
    {
      ...
      time: "All Day",
      type: "Las Vegas, NV",
      description: "Showcasing ArrowChain platform capabilities"
    },
    {
      date: "April 8, 2025",
  ...
  const investmentHighlights = [
    ...
    },
    {
      ...
      description: "Proprietary ArrowChain platform enabling rapid vertical expansion",
      icon: TrendingUp,
      color: "green"
    },
    {
